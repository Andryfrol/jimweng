...
type NtnxStorageContainers struct {
	Metadata struct {
	...
	Entities []struct {
		...
		} `json:"down_migrate_times_in_secs"`
		...
		CompressionDelayInSecs interface{} `json:"compression_delay_in_secs"`
		VstoreNameList         []string    `json:"vstore_name_list"`
		MappedRemoteContainers struct {
		} `json:"mapped_remote_containers"`
		Stats struct {
