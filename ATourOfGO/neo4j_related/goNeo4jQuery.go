...
func main() {
	var test = neo4jQueryNodes("query")
	fmt.Println(reflect.TypeOf(test))
	fmt.Println(test)
	fmt.Println(test=="+testDomainID+testDomainID2+testDomainID3")
	fmt.Println(strings.Contains(test,"+testDomainID2+testDomainID3+testDomainID"))
}
