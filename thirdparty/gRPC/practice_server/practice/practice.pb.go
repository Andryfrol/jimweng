...
func (m *PracticeRequest) Reset()         { *m = PracticeRequest{} }
...
func (m *PracticeRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_PracticeRequest.DiscardUnknown(m)
}

var xxx_messageInfo_PracticeRequest proto.InternalMessageInfo

func (m *PracticeRequest) GetName() string {
	if m != nil {
		return m.Name
	}
	return ""
...
func (m *PracticeReply) Reset()         { *m = PracticeReply{} }
...
func (m *PracticeReply) XXX_DiscardUnknown() {
	xxx_messageInfo_PracticeReply.DiscardUnknown(m)
}

var xxx_messageInfo_PracticeReply proto.InternalMessageInfo

func (m *PracticeReply) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
